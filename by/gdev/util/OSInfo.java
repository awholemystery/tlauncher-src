...
/* loaded from: TLauncher-2.876.jar:by/gdev/util/OSInfo.class */
public class OSInfo {
    ...
    /* loaded from: TLauncher-2.876.jar:by/gdev/util/OSInfo$Arch.class */
    public enum Arch {
        x32,
        x64
    }

    /* loaded from: TLauncher-2.876.jar:by/gdev/util/OSInfo$OSType.class */
    public enum OSType {
        WINDOWS,
        LINUX,
        SOLARIS,
    ...
    /* loaded from: TLauncher-2.876.jar:by/gdev/util/OSInfo$WindowsVersion.class */
