...
/* loaded from: TLauncher-2.876.jar:ch/qos/logback/classic/Level.class */
public final class Level implements Serializable {
    ...
    public static final Level TRACE = new Level(5000, HttpTrace.METHOD_NAME);
    ...
    public static Level toLevel(String sArg, Level defaultLevel) {
        ...
        if (sArg.equalsIgnoreCase(Rule.ALL)) {
            return ALL;
        }
        if (sArg.equalsIgnoreCase(HttpTrace.METHOD_NAME)) {
            return TRACE;
        }
