...
/* loaded from: TLauncher-2.876.jar:ch/qos/logback/classic/joran/action/ConfigurationAction.class */
public class ConfigurationAction extends Action {
    ...
    public void begin(InterpretationContext ic, String name, Attributes attributes) {
        ...
        if (OptionHelper.isEmpty(debugAttrib) || debugAttrib.equalsIgnoreCase("false") || debugAttrib.equalsIgnoreCase(Configurator.NULL)) {
