...
/* loaded from: TLauncher-2.876.jar:ch/qos/logback/classic/joran/action/LoggerAction.class */
public class LoggerAction extends Action {
    ...
    public void begin(InterpretationContext ec, String name, Attributes attributes) {
        ...
        String loggerName = ec.subst(attributes.getValue(Action.NAME_ATTRIBUTE));
        ...
        if (!OptionHelper.isEmpty(levelStr)) {
            if (ActionConst.INHERITED.equalsIgnoreCase(levelStr) || "NULL".equalsIgnoreCase(levelStr)) {
