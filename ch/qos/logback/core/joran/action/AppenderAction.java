...
/* loaded from: TLauncher-2.876.jar:ch/qos/logback/core/joran/action/AppenderAction.class */
public class AppenderAction<E> extends Action {
    ...
    public void begin(InterpretationContext ec, String localName, Attributes attributes) throws ActionException {
        ...
        try {
            ...
            String appenderName = ec.subst(attributes.getValue(Action.NAME_ATTRIBUTE));
