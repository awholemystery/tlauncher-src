...
/* loaded from: TLauncher-2.876.jar:ch/qos/logback/core/joran/action/NestedComplexPropertyIA.class */
public class NestedComplexPropertyIA extends ImplicitAction {
    ...
    public void begin(InterpretationContext ec, String localName, Attributes attributes) {
        ...
        String className = ec.subst(attributes.getValue(Action.CLASS_ATTRIBUTE));
        try {
