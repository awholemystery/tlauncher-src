...
/* loaded from: TLauncher-2.876.jar:ch/qos/logback/core/net/SMTPAppenderBase.class */
public abstract class SMTPAppenderBase<E> extends AppenderBase<E> {
    ...
    private Session lookupSessionInJNDI() {
        ...
        try {
            ...
            Object obj = JNDIUtil.lookup(initialContext, this.jndiLocation);
            return (Session) obj;
        } catch (Exception e) {
    ...
    public List<String> getToAsListOfString() {
        ...
        for (PatternLayoutBase plb : this.toPatternLayoutList) {
    ...
    /* loaded from: TLauncher-2.876.jar:ch/qos/logback/core/net/SMTPAppenderBase$SenderRunnable.class */
