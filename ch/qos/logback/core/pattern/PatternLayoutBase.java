...
/* loaded from: TLauncher-2.876.jar:ch/qos/logback/core/pattern/PatternLayoutBase.class */
public abstract class PatternLayoutBase<E> extends LayoutBase<E> {
    ...
    public Map<String, String> getEffectiveConverterMap() {
        ...
        if (context != null && (contextMap = (Map) context.getObject("PATTERN_RULE_REGISTRY")) != null) {
