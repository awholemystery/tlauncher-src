...
/* loaded from: TLauncher-2.876.jar:net/minecraft/common/NBTTagList.class */
public class NBTTagList extends NBTBase {
    ...
    public String toString() {
        return CoreConstants.EMPTY_STRING + this.tagList.size() + " entries of type " + NBTBase.getTagName(this.tagType);
    }
