...
/* loaded from: TLauncher-2.876.jar:net/minecraft/launcher/process/LimitedCapacityList.class */
public class LimitedCapacityList<T> {
    ...
    public LimitedCapacityList(Class<? extends T> clazz, int maxSize) {
        this.clazz = clazz;
        this.items = (T[]) ((Object[]) Array.newInstance(clazz, maxSize));
    }
    ...
    public T[] getItems() {
        T[] result = (T[]) ((Object[]) Array.newInstance(this.clazz, this.size));
        this.locks.readLock().lock();
