...
/* loaded from: TLauncher-2.876.jar:org/apache/commons/codec/binary/Base64.class */
    ...
    public void encode(byte[] in, int inPos, int inAvail, BaseNCodec.Context context) {
        ...
        for (int i9 = 0; i9 < inAvail; i9++) {
            ...
            if (0 == context.modulus) {
                int i11 = context.pos;
                context.pos = i11 + 1;
                buffer2[i11] = this.encodeTable[(context.ibitWorkArea >> 18) & MASK_6BITS];
                int i12 = context.pos;
                context.pos = i12 + 1;
                buffer2[i12] = this.encodeTable[(context.ibitWorkArea >> 12) & MASK_6BITS];
                int i13 = context.pos;
                context.pos = i13 + 1;
                buffer2[i13] = this.encodeTable[(context.ibitWorkArea >> 6) & MASK_6BITS];
                int i14 = context.pos;
                context.pos = i14 + 1;
                buffer2[i14] = this.encodeTable[context.ibitWorkArea & MASK_6BITS];
