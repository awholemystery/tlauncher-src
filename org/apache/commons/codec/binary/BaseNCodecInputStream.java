...
/* loaded from: TLauncher-2.876.jar:org/apache/commons/codec/binary/BaseNCodecInputStream.class */
        ...
        while (true) {
            ...
            if (readLen == 0) {
                if (!this.baseNCodec.hasData(this.context)) {
                    byte[] buf = new byte[this.doEncode ? CpioConstants.C_ISFIFO : 8192];
                ...
                i = this.baseNCodec.readResults(b, offset, len, this.context);
            } else {
                return readLen;
            }
        }
