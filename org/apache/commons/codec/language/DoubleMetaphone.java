...
/* loaded from: TLauncher-2.876.jar:org/apache/commons/codec/language/DoubleMetaphone.class */
public class DoubleMetaphone implements StringEncoder {
    ...
    private int handleT(String value, DoubleMetaphoneResult result, int index) {
        ...
        if (contains(value, index, 4, "TION")) {
            ...
            result.append('T');
            index2 = contains(value, index + 1, 1, "T", "D") ? index + 2 : index + 1;
        }
        return index2;
    }
    ...
    private int handleX(String value, DoubleMetaphoneResult result, int index) {
        ...
        if (index == 0) {
            ...
            index2 = contains(value, index + 1, 1, "C", "X") ? index + 2 : index + 1;
        }
        return index2;
    }
    ...
    /* loaded from: TLauncher-2.876.jar:org/apache/commons/codec/language/DoubleMetaphone$DoubleMetaphoneResult.class */
