...
/* loaded from: TLauncher-2.876.jar:org/apache/commons/codec/net/QCodec.class */
public class QCodec extends RFC1522Codec implements StringEncoder, StringDecoder {
    ...
    static {
        ...
        PRINTABLE_CHARS.set(CoreConstants.CURLY_LEFT);
        PRINTABLE_CHARS.set(124);
        PRINTABLE_CHARS.set(CoreConstants.CURLY_RIGHT);
