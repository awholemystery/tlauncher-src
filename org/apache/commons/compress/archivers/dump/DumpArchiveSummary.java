...
/* loaded from: TLauncher-2.876.jar:org/apache/commons/compress/archivers/dump/DumpArchiveSummary.class */
public class DumpArchiveSummary {
    ...
    public DumpArchiveSummary(byte[] buffer, ZipEncoding encoding) throws IOException {
    ...
    public int hashCode() {
        ...
        int hash2 = (int) (hash + (31 * this.dumpDate));
        if (this.hostname != null) {
            hash2 = (31 * this.hostname.hashCode()) + 17;
        }
        if (this.devname != null) {
            hash2 = (31 * this.devname.hashCode()) + 17;
        }
        return hash2;
    }
    ...
    public boolean equals(Object o) {
        ...
        return this.dumpDate == rhs.dumpDate && getHostname() != null && getHostname().equals(rhs.getHostname()) && getDevname() != null && getDevname().equals(rhs.getDevname());
    }
}
