...
/* loaded from: TLauncher-2.876.jar:org/apache/commons/compress/archivers/zip/GeneralPurposeBit.class */
public final class GeneralPurposeBit implements Cloneable {
    ...
    public static GeneralPurposeBit parse(byte[] data, int offset) {
        ...
        b.slidingDictionarySize = (generalPurposeFlag & 2) != 0 ? 8192 : CpioConstants.C_ISFIFO;
    ...
    public Object clone() {
        try {
            ...
            throw new IllegalStateException("GeneralPurposeBit is not Cloneable?", ex);
        }
    }
}
