...
/* loaded from: TLauncher-2.876.jar:org/apache/commons/compress/harmony/unpack200/bytecode/forms/ByteCodeForm.class */
public abstract class ByteCodeForm {
    ...
    static {
        ...
        byteCodeArray[101] = new NoArgumentForm(HttpStatus.SC_SWITCHING_PROTOCOLS, "lsub");
        byteCodeArray[102] = new NoArgumentForm(HttpStatus.SC_PROCESSING, "fsub");
        byteCodeArray[103] = new NoArgumentForm(TarConstants.LF_PAX_GLOBAL_EXTENDED_HEADER, "dsub");
        byteCodeArray[104] = new NoArgumentForm(SyslogConstants.LOG_AUDIT, "imul");
        ...
        byteCodeArray[112] = new NoArgumentForm(SyslogConstants.LOG_ALERT, "irem");
        ...
        byteCodeArray[116] = new NoArgumentForm(116, CoreConstants.EMPTY_STRING);
        ...
        byteCodeArray[123] = new NoArgumentForm(CoreConstants.CURLY_LEFT, "lshr");
        byteCodeArray[124] = new NoArgumentForm(124, "iushr");
        byteCodeArray[125] = new NoArgumentForm(CoreConstants.CURLY_RIGHT, "lushr");
        ...
        byteCodeArray[130] = new NoArgumentForm(CompleteSubEntityScene.BUTTON_PANEL_SUB_VIEW, "ixor");
        byteCodeArray[131] = new NoArgumentForm(TarConstants.PREFIXLEN_XSTAR, "lxor");
        ...
        byteCodeArray[148] = new NoArgumentForm(TarConstants.CHKSUM_OFFSET, "lcmp");
        ...
        byteCodeArray[155] = new LabelForm(TarConstants.PREFIXLEN, "iflt", new int[]{TarConstants.PREFIXLEN, -1, -1});
        byteCodeArray[156] = new LabelForm(TarConstants.LF_OFFSET, "ifge", new int[]{TarConstants.LF_OFFSET, -1, -1});
        ...
        byteCodeArray[200] = new LabelForm(HttpStatus.SC_OK, "goto_w", new int[]{HttpStatus.SC_OK, -1, -1, -1, -1}, true);
        byteCodeArray[201] = new LabelForm(HttpStatus.SC_CREATED, "jsr_w", new int[]{HttpStatus.SC_CREATED, -1, -1, -1, -1}, true);
        byteCodeArray[202] = new ThisFieldRefForm(HttpStatus.SC_ACCEPTED, "getstatic_this", new int[]{178, -1, -1});
        byteCodeArray[203] = new ThisFieldRefForm(HttpStatus.SC_NON_AUTHORITATIVE_INFORMATION, "putstatic_this", new int[]{179, -1, -1});
        byteCodeArray[204] = new ThisFieldRefForm(HttpStatus.SC_NO_CONTENT, "getfield_this", new int[]{180, -1, -1});
        ...
        byteCodeArray[215] = new ThisMethodRefForm(ModpackScene.WIDTH_SEARCH_PANEL, "aload_0_invokestatic_this", new int[]{42, 184, -1, -1});
        ...
        byteCodeArray[223] = new SuperFieldRefForm(CompleteSubEntityScene.FullGameEntity.CompleteDescriptionGamePanel.SHADOW_PANEL, "aload_0_getstatic_super", new int[]{42, 178, -1, -1});
    ...
    protected void calculateOperandPosition() {
        ...
        for (int iterationIndex2 = this.firstOperandIndex; iterationIndex2 < this.rewrite.length; iterationIndex2++) {
            if (this.rewrite[iterationIndex2] < 0) {
                lastOperandIndex = iterationIndex2;
            }
        }
