...
@Deprecated
/* loaded from: TLauncher-2.876.jar:org/apache/commons/io/DirectoryWalker.class */
public abstract class DirectoryWalker<T> {
    ...
    protected DirectoryWalker(IOFileFilter directoryFilter, IOFileFilter fileFilter, int depthLimit) {
        if (directoryFilter == null && fileFilter == null) {
            ...
            this.filter = FileFilterUtils.makeDirectoryOnly(directoryFilter != null ? directoryFilter : TrueFileFilter.TRUE).or(FileFilterUtils.makeFileOnly(fileFilter != null ? fileFilter : TrueFileFilter.TRUE));
        }
        this.depthLimit = depthLimit;
    }
    ...
    /* loaded from: TLauncher-2.876.jar:org/apache/commons/io/DirectoryWalker$CancelException.class */
