...
@NotThreadSafe
/* loaded from: TLauncher-2.876.jar:org/apache/http/client/entity/EntityBuilder.class */
public class EntityBuilder {
    ...
    public HttpEntity build() {
        ...
        if (this.text != null) {
            ...
            e = new InputStreamEntity(this.stream, -1L, getContentOrDefault(ContentType.DEFAULT_BINARY));
