...
@Immutable
/* loaded from: TLauncher-2.876.jar:org/apache/http/client/utils/URLEncodedUtils.class */
    ...
    public static void parse(List<NameValuePair> parameters, Scanner scanner, String parameterSepartorPattern, String charset) {
        ...
        while (scanner.hasNext()) {
            ...
            if (i != -1) {
                ...
                str = decodeFormFields(token.substring(i + 1).trim(), charset);
            } else {
