...
@ThreadSafe
/* loaded from: TLauncher-2.876.jar:org/apache/http/conn/ssl/SSLConnectionSocketFactory.class */
    ...
    private void verifyHostname(SSLSocket sslsock, String hostname) throws IOException {
        try {
            ...
            if (!this.hostnameVerifier.verify(hostname, session)) {
                Certificate[] certs2 = session.getPeerCertificates();
                X500Principal x500Principal = ((X509Certificate) certs2[0]).getSubjectX500Principal();
