...
@ThreadSafe
@Deprecated
/* loaded from: TLauncher-2.876.jar:org/apache/http/conn/ssl/SSLSocketFactory.class */
public class SSLSocketFactory implements LayeredConnectionSocketFactory, SchemeLayeredSocketFactory, LayeredSchemeSocketFactory, LayeredSocketFactory {
    ...
    public Socket connectSocket(Socket socket, InetSocketAddress remoteAddress, InetSocketAddress localAddress, HttpParams params) throws IOException, UnknownHostException, ConnectTimeoutException {
        ...
        if (remoteAddress instanceof HttpInetSocketAddress) {
            ...
            host = new HttpHost(remoteAddress.getHostName(), remoteAddress.getPort(), CachingURLStreamHandlerFactory.PROTO_HTTPS);
        }
