...
@Deprecated
@Immutable
/* loaded from: TLauncher-2.876.jar:org/apache/http/impl/client/AbstractAuthenticationHandler.class */
public abstract class AbstractAuthenticationHandler implements AuthenticationHandler {
    ...
    public Map<String, Header> parseChallenges(Header[] headers) throws MalformedChallengeException {
        ...
        for (Header header : headers) {
            ...
            int endIndex = pos;
            map.put(buffer.substring(beginIndex, endIndex).toLowerCase(Locale.ROOT), header);
        }
        return map;
    }
