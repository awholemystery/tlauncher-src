...
@Immutable
/* loaded from: TLauncher-2.876.jar:org/apache/http/protocol/HttpService.class */
public class HttpService {
    ...
    private boolean canResponseHaveBody(HttpRequest request, HttpResponse response) {
        int status;
        return ((request != null && HttpHead.METHOD_NAME.equalsIgnoreCase(request.getRequestLine().getMethod())) || (status = response.getStatusLine().getStatusCode()) < 200 || status == 204 || status == 304 || status == 205) ? false : true;
    }
    ...
    @Deprecated
    /* loaded from: TLauncher-2.876.jar:org/apache/http/protocol/HttpService$HttpRequestHandlerResolverAdapter.class */
