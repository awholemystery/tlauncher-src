...
@NotThreadSafe
/* loaded from: TLauncher-2.876.jar:org/apache/http/util/CharArrayBuffer.class */
public final class CharArrayBuffer implements CharSequence, Serializable {
    ...
    public void append(String str) {
        String s = str != null ? str : Configurator.NULL;
        int strlen = s.length();
    ...
    public int indexOf(int ch2, int from, int to) {
        int beginIndex = from;
        if (beginIndex < 0) {
            beginIndex = 0;
        }
