...
/* loaded from: TLauncher-2.876.jar:org/apache/log4j/PropertyConfigurator.class */
public class PropertyConfigurator implements Configurator {
    ...
    void parseAdditivityForLogger(Properties props, Logger cat, String loggerName) {
        ...
        if (value != null && !value.equals(CoreConstants.EMPTY_STRING)) {
    ...
    void parseCategory(Properties props, Logger logger, String optionKey, String loggerName, String value) {
        ...
        if (!value.startsWith(",") && !value.equals(CoreConstants.EMPTY_STRING)) {
            if (!st.hasMoreTokens()) {
                return;
            }
