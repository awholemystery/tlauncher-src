...
/* loaded from: TLauncher-2.876.jar:org/apache/log4j/chainsaw/ControlPanel.class */
class ControlPanel extends JPanel {
    ...
    public ControlPanel(MyTableModel aModel) {
        ...
        c.fill = 2;
        c.gridy++;
        JTextField threadField = new JTextField(CoreConstants.EMPTY_STRING);
        ...
        add(threadField);
        c.gridy++;
        JTextField catField = new JTextField(CoreConstants.EMPTY_STRING);
        ...
        add(catField);
        c.gridy++;
        JTextField ndcField = new JTextField(CoreConstants.EMPTY_STRING);
        ...
        add(ndcField);
        c.gridy++;
        JTextField msgField = new JTextField(CoreConstants.EMPTY_STRING);
