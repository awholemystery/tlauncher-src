...
/* loaded from: TLauncher-2.876.jar:org/apache/log4j/chainsaw/Main.class */
public class Main extends JFrame {
    ...
    private Main() {
        ...
        scrollPane.setPreferredSize(new Dimension(900, (int) HttpStatus.SC_MULTIPLE_CHOICES));
        JPanel details = new DetailPanel(table, model);
        details.setPreferredSize(new Dimension(900, (int) HttpStatus.SC_MULTIPLE_CHOICES));
