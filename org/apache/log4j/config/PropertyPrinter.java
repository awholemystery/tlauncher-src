...
/* loaded from: TLauncher-2.876.jar:org/apache/log4j/config/PropertyPrinter.class */
public class PropertyPrinter implements PropertyGetter.PropertyCallback {
    ...
    protected void printOptions(PrintWriter out, Category cat) {
        ...
        String level = prio == null ? CoreConstants.EMPTY_STRING : prio.toString();
        while (true) {
        ...
        if (appenderString != CoreConstants.EMPTY_STRING) {
    ...
    public void foundProperty(Object obj, String prefix, String name, Object value) {
        if ((obj instanceof Appender) && Action.NAME_ATTRIBUTE.equals(name)) {
            return;
        }
