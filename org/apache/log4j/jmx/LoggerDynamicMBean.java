...
/* loaded from: TLauncher-2.876.jar:org/apache/log4j/jmx/LoggerDynamicMBean.class */
public class LoggerDynamicMBean extends AbstractDynamicMBean implements NotificationListener {
    ...
    private void buildDynamicMBeanInfo() {
        ...
        this.dAttributes.add(new MBeanAttributeInfo(Action.NAME_ATTRIBUTE, "java.lang.String", "The name of this Logger.", true, false, false));
    ...
    public Object getAttribute(String attributeName) throws AttributeNotFoundException, MBeanException, ReflectionException {
        ...
        if (attributeName.equals(Action.NAME_ATTRIBUTE)) {
    ...
    public void setAttribute(Attribute attribute) throws AttributeNotFoundException, InvalidAttributeValueException, MBeanException, ReflectionException {
        ...
        if (name.equals(LogFactory.PRIORITY_KEY)) {
    ...
    void registerAppenderMBean(Appender appender) {
        ...
        try {
            ...
            ObjectName objectName = new ObjectName("log4j", ActionConst.APPENDER_TAG, name);
