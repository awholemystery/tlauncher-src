...
/* loaded from: TLauncher-2.876.jar:org/apache/log4j/lf5/viewer/LogTable.class */
public class LogTable extends JTable {
    ...
    protected int[] _colWidths = {40, 40, 40, 70, 70, 360, 440, HttpStatus.SC_OK, 60};
    ...
    /* loaded from: TLauncher-2.876.jar:org/apache/log4j/lf5/viewer/LogTable$LogTableListSelectionListener.class */
        ...
        public void valueChanged(ListSelectionEvent e) {
            ...
            if (!lsm.isSelectionEmpty()) {
                ...
                for (int i = 0; i < this.this$0._numCols - 1; i++) {
                    String value = CoreConstants.EMPTY_STRING;
