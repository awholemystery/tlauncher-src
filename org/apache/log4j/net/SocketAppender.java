...
/* loaded from: TLauncher-2.876.jar:org/apache/log4j/net/SocketAppender.class */
public class SocketAppender extends AppenderSkeleton {
    ...
    /* loaded from: TLauncher-2.876.jar:org/apache/log4j/net/SocketAppender$Connector.class */
        ...
        public void run() {
            while (!this.interrupted) {
                try {
                    ...
                    LogLog.debug(new StringBuffer().append("Could not connect to ").append(this.this$0.address.getHostName()).append(". Exception is ").append(e2).toString());
