...
/* loaded from: TLauncher-2.876.jar:org/apache/log4j/net/SyslogAppender.class */
    ...
    public void append(LoggingEvent event) {
        ...
        if ((this.layout == null || this.layout.ignoresThrowable()) && (s = event.getThrowableStrRep()) != null) {
            for (int i = 0; i < s.length; i++) {
                if (s[i].startsWith(ch.qos.logback.classic.net.SyslogAppender.DEFAULT_STACKTRACE_PATTERN)) {
