...
/* loaded from: TLauncher-2.876.jar:org/apache/log4j/pattern/BridgePatternConverter.class */
    ...
    public BridgePatternConverter(String pattern) {
        ...
        for (Object converter : converters) {
            if (converter instanceof LoggingEventPatternConverter) {
                ...
                this.patternConverters[i] = new LiteralPatternConverter(CoreConstants.EMPTY_STRING);
            }
