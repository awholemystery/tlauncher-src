...
/* loaded from: TLauncher-2.876.jar:org/apache/log4j/pattern/PatternParser.class */
public final class PatternParser {
    ...
    static {
        ...
        rules.put(Action.CLASS_ATTRIBUTE, cls4);
        ...
        rules.put(DateTokenConverter.CONVERTER_KEY, cls5);
        if (class$org$apache$log4j$pattern$DatePatternConverter == null) {
        ...
        rules.put(Action.FILE_ATTRIBUTE, cls8);
        ...
        rules.put(ANSIConstants.ESC_END, cls12);
        if (class$org$apache$log4j$pattern$MessagePatternConverter == null) {
        ...
        fnameRules.put(DateTokenConverter.CONVERTER_KEY, cls30);
        if (class$org$apache$log4j$pattern$FileDatePatternConverter == null) {
        ...
        fnameRules.put(IntegerTokenConverter.CONVERTER_KEY, cls32);
        if (class$org$apache$log4j$pattern$IntegerPatternConverter == null) {
    ...
    private static int extractOptions(String pattern, int i, List options) {
        int end;
        while (i < pattern.length() && pattern.charAt(i) == '{' && (end = pattern.indexOf(CoreConstants.CURLY_RIGHT, i)) != -1) {
    ...
    /* loaded from: TLauncher-2.876.jar:org/apache/log4j/pattern/PatternParser$ReadOnlyMap.class */
